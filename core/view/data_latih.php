			...
			<div id="importCollapseForm" class="collapse"><div class="border border-dark rounded p-4 mb-4">
				<form method="post" enctype="multipart/form-data" action="<?=BASEDOMAIN?>/training/upload">
                    ...
                    <div class="d-flex px-4">
                        ...
                        <a href="javascript:window.open('<?=BASEDOMAIN?>/download/excel_template_data_latih','_self').close();" class="btn btn-info mr-5"><i class="fas fa-file-download"></i> Download Excel Template</a>
                        <a href="<?=BASEDOMAIN?>/training/empty" onclick="return confirmDelete()" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Hapus Semua</a>
                    </div>
                </form>
			</div></div>
